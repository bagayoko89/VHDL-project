...
`timescale 1 ps / 1 ps
module gpio_nios_mm_interconnect_0 (
	...
	wire   [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // memory_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> memory_s1_agent:cp_channel
	...
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> entree_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> entree_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // entree_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> entree_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> entree_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> entree_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> sortie_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> sortie_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // sortie_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> sortie_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> sortie_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> sortie_s1_agent:cp_endofpacket
	...
	wire  [92:0] memory_s1_agent_rp_data;                                                   // memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire         entree_s1_agent_rp_valid;                                                  // entree_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] entree_s1_agent_rp_data;                                                   // entree_s1_agent:rp_data -> router_006:sink_data
	wire         entree_s1_agent_rp_ready;                                                  // router_006:sink_ready -> entree_s1_agent:rp_ready
	wire         entree_s1_agent_rp_startofpacket;                                          // entree_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         entree_s1_agent_rp_endofpacket;                                            // entree_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         sortie_s1_agent_rp_valid;                                                  // sortie_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] sortie_s1_agent_rp_data;                                                   // sortie_s1_agent:rp_data -> router_007:sink_data
	wire         sortie_s1_agent_rp_ready;                                                  // router_007:sink_ready -> sortie_s1_agent:rp_ready
	wire         sortie_s1_agent_rp_startofpacket;                                          // sortie_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         sortie_s1_agent_rp_endofpacket;                                            // sortie_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         entree_s1_agent_rdata_fifo_src_valid;                                      // entree_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] entree_s1_agent_rdata_fifo_src_data;                                       // entree_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         entree_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> entree_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> entree_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> entree_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // entree_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> entree_s1_agent:rdata_fifo_sink_error
	wire         sortie_s1_agent_rdata_fifo_src_valid;                                      // sortie_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] sortie_s1_agent_rdata_fifo_src_data;                                       // sortie_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         sortie_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> sortie_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> sortie_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> sortie_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // sortie_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> sortie_s1_agent:rdata_fifo_sink_error
	...
	gpio_nios_mm_interconnect_0_router router (
	...
	gpio_nios_mm_interconnect_0_router_001 router_001 (
	...
	gpio_nios_mm_interconnect_0_router_002 router_002 (
	...
	gpio_nios_mm_interconnect_0_router_002 router_003 (
	...
	gpio_nios_mm_interconnect_0_router_004 router_004 (
	...
	gpio_nios_mm_interconnect_0_router_004 router_005 (
	...
	gpio_nios_mm_interconnect_0_router_002 router_006 (
	...
	gpio_nios_mm_interconnect_0_router_002 router_007 (
	...
	gpio_nios_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gpio_nios_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
